...
DROP DATABASE IF EXISTS `eiendomforsalg01`;
...
-- Dumping data for table eiendomforsalg01.users: ~0 rows (approximately)
...
INSERT INTO `users` (`id`, `usertype`, `name`, `email`, `password`, `phone`, `fax`, `city`, `about`, `facebook`, `twitter`, `gplus`, `linkedin`, `image_icon`, `status`, `confirmation_code`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Admin', 'admin', 'admin@gmail.com', '$2y$10$6qlNS9DOMa56JyNs5T34SueBz7UVVvckdOmYxOdZEuQvSbXlbu0Kq', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2sck1ewU6bLOpoZa2UtP37toyJctdVIAVLlHNgiRQcUoZBcz1PGD4teGXkSQ', '2019-05-29 06:46:58', '2019-12-20 20:36:29');
