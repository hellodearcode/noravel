          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="widget">
              ...
              <ul class="list-unstyled">
                <li><a href="{{ URL::to('about-us') }}">Om oss</a></li>
                <li><a href="{{ URL::to('contact-us') }}">Kontakt Oss</a></li>

                <li><a href="{{ URL::to('careers-with-us')}}">Kariere</a></li>
                <li><a href="{{ URL::to('terms-conditions')}}">Vilkår og betingelser</a></li>
                <li><a href="{{ URL::to('privacy-policy')}}">Personvern</a></li>
              </ul>
            </div>
          </div>
          <!-- break -->
