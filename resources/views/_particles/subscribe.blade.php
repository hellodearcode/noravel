...
<!-- begin:subscribe -->
    <div id="subscribe">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3>Meld deg på vårt<br>nyhetsbrev</h3>
          </div>
      	</div>
      	<div class="row">
          <div class="col-md-5">
              <meta name="_token" content="{!! csrf_token() !!}"/>
              <input type="text" name="name" id="name_id" class="form-control input-lg" placeholder="Navn:">
          </div>
          <div class="col-md-5">
              <input type="email" name="email" id="email_id" class="form-control input-lg" placeholder="Epost:">
          </div>
          <div class="col-md-2">
