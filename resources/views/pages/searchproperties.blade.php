                ...
                {!! Form::open(array('url' => array('search'),'name'=>'search_form','id'=>'search_form','role'=>'form')) !!}
                  <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="form-group">
                      <label for="bedroom">Søkeord</label>
                      <input type="text" name="keyword" class="form-control" placeholder="Skriv inn søkeord">
                    </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="submit" name="submit" value="Søk igjen" class="btn btn-primary btn-block">
                    </div>
                  </div>
